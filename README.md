...
**Security+ Mapping:** Domain 2 — Threat Intelligence & Malware Types

---

## 02. CVE-2019-20183 — Unrestricted File Upload & RCE
...
## 05. Unquoted Service Path Privilege Escalation
...
- [Network Security Defence](https://github.com/Cyril556/network-security-defence) — LAN design, DMZ architecture, DDoS mitigation
- [CCorp SIRTS](https://github.com/Cyril556/ccorp-sirts) — Security Incident Response & Ticketing System
- [SY0-701 Exam Simulator](https://github.com/Cyril556/sy0-701-simulator) — CompTIA Security+ practice platform
